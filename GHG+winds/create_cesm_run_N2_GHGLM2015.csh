...
# 	Initialized from GHG_UVnudge_LM year 2015
#****************************************************************

## Set option variables in this section
# Set case parameters & name
set CASETITLE=GHG_UVnudge_LM2015
set RES=f09_g17
set COMPSET=B1850cmip6
set COMPSET_SHORT=b
set STARTDATE=2015-01-01

set REFCASE=${COMPSET_SHORT}.e21.${COMPSET}.${RES}.GHG_UVnudge_LM.
...
foreach i ( 1 )
	...
	if ($CONT_RUN == FALSE) then
		...
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/ssp370-ghg/user_nl_cam .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/ssp370-ghg/user_nl_clm .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/ssp370-ghg/user_nl_cice .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/ssp370-ghg/user_nl_cpl .
