...
#
# Notes:
# 	Historical GHG, pre-industial other forcings, winds are historical
# 	Initialized from PInudge-lessmelt yr 2024
#****************************************************************

## Set option variables in this section
# Set case parameters & name
set CASETITLE=GHG_UVnudge_LM
set RES=f09_g17
set COMPSET=B1850cmip6
set COMPSET_SHORT=b
set STARTDATE=1950-01-01

set REFCASE=${COMPSET_SHORT}.e21.${COMPSET}.${RES}.PiC_UVnudge_LM2006.
...
foreach i ( 1 2 3 )
	...
	if ($CONT_RUN == FALSE) then
		...
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/hist-ghg/user_nl_cam .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/hist-ghg/user_nl_clm .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/hist-ghg/user_nl_cice .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/cesm2-sf/hist-ghg/user_nl_cpl .
	...
	if ($CONT_RUN == TRUE) then
		...
		./xmlchange STOP_N=5,STOP_OPTION="nyears",RESUBMIT=11,REST_N=5,REST_OPTION="nyears",CONTINUE_RUN=$CONT_RUN
